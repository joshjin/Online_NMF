...
%     imwrite(pic3, sprintf('mnist_features/f_%d_a_u_nmf.jpg', i'));
end
...
%     imwrite(reshape(W3(:, i), [28, 28]), sprintf('mnist_features/Z_basis_addi_%d.jpg', i'));
end
